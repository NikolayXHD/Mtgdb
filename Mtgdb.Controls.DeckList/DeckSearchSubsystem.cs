...
namespace Mtgdb.Controls
{
	public class DeckSearchSubsystem : ISearchSubsystem<int>
	{
		...
		public void SubscribeToEvents()
		{
			...
			_viewDecks.SearchClicked += gridSearchClicked;
		}
		...
		private void cycleValue(bool backward)
		{
			...
			var cycleSuggest = _searcher.CycleValue(currentState, backward, Ui);
		...
		public DeckSuggestModel SuggestModel { get; set; }
		...
		private readonly LayoutViewControl _viewDecks;
