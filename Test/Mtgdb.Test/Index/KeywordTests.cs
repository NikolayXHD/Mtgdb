...
namespace Mtgdb.Test
{
	...
	public class KeywordTests : TestsBase
	{
		...
		[TestCase(@"Text: *affinity* AND NOT Keywords: affinity AND NOT Type: card")]
		[TestCase(@"Text: *afflict* AND NOT Keywords: afflict AND NOT Name: afflict* AND NOT Type: card")]
		...
		[TestCase(@"Text: *delv* AND NOT Keywords: delve AND NOT Name: delver AND NOT Type: card")]
