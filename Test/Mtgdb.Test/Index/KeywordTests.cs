...
namespace Mtgdb.Test
{
	...
	public class KeywordTests : TestsBase
	{
		...
		[TestCase(
			@"Text: ante* AND NOT (Keywords: ante OR Name: (ante* OR ""master of the wild hunt avatar""))")]
		[TestCase(
			@"Text: *ascend* AND NOT Keywords: ascend AND NOT Name: (ascendant OR ascending OR ascendancy)")]
		[TestCase(@"Text: (*attach* AND NOT unattach*) AND NOT Keywords: attach")]
		[TestCase(@"Text: (*unattach*) AND NOT Keywords: unattach")]
		[TestCase(
			@"Text: (""/attacks?/ if able""~10 AND NOT ""/attacks?/ /block(s|ed)?/ if able""~10) AND NOT Keywords: ""attack if able""")]
		[TestCase(
			@"Keywords: ""attack if able"" AND Text: (NOT (""/attacks?/ if able""~3 OR ""/attacks?/ (this OR next OR each) (turn OR combat) if able""~11))")]
		[TestCase(
			@"Text: (""/block(s|ed)?/ if able""~10 OR ""able to block"" OR ""must be blocked""~3 OR ""must block""~3) AND NOT Keywords: ""block if able""")]
		[TestCase(
		...
		[TestCase(
			@"Text: (""(can't attack""~5 OR ""/(can)?not/ attack""~5) AND NOT Keywords: ""can't attack""")]
		[TestCase(
			@"Keywords: ""can't attack"" AND NOT Text: (""can't attack"" OR ""you can't be attacked"")")]
		[TestCase(
			@"Text: ""can't block""~5 AND NOT Keywords: ""can't block"" AND NOT Name: ""Wall of Air""")]
		[TestCase(
			@"Keywords: ""can't block"" AND NOT Text: (""can't block"" OR ""can't attack or block"" OR ""can't attack, block"")")]
		[TestCase(
			@"Text: (""can't be blocked""~6 AND NOT ""works on creatures that can't be blocked"") AND NOT Keywords: ""can't be blocked""")]
		[TestCase(
			@"Keywords: ""can't be blocked"" AND NOT Text: (""can't be blocked"" OR ""can't block or be blocked"")")]
		...
		[TestCase(
			@"Text: (""can't block""~8 AND NOT ""can block"") AND NOT Keywords: ""can't block"" AND NOT Name: Tromokratis")]
		[TestCase(
			@"Keywords: ""can't block"" AND NOT Text: (""can't block"" OR ""can't attack or block"" OR ""can't attack, block"")")]
		...
		[TestCase(
			@"Text: (/counter(s|ed)?/ AND NOT (""counter* (from OR on OR put OR to OR are OR aren't OR can't)"" OR ""(\+ OR \-) /[0-9]/ /counters?/"" OR ""can't be countered"" OR ""(poison OR energy OR experience OR lore) /counters?/"")) AND NOT keywords: counter")]
		[TestCase(
			@"Keywords: counter AND NOT Text: ((countered AND NOT ""can't be countered"") OR ""counter it"" OR ""/counters?/ (target OR a OR all OR that OR the) (/spells?/ OR /abilit(y|ies)/ OR instant OR creature)""~3) AND NOT Name: (""Brain Gorgers"" OR Phantasmagorian OR ""Temporal Extortion"")")]
		...
		[TestCase(
			@"Text: (*cycl* AND NOT (cyclo*)) AND NOT Keywords: cycling AND NOT Name: (cyclical OR ""cycle of life"" OR recycler)")]
		[TestCase(
			@"Keywords: cycling AND NOT Text: (*cycling OR ""cycles a card"" OR ""can't cycle cards"" OR ""cycle or discard a card"" OR ""cycled or discarded"")")]
		...
		[TestCase(
			@"Text: (*destr* AND NOT indestructible) AND NOT Keywords: destroy AND NOT Name: destructi*")]
