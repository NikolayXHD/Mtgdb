...
namespace Mtgdb.Gui
{
	partial class FormChart
	{
		...
		private void InitializeComponent()
		{
			...
			this._buttonArgumentTotal = new Mtgdb.Controls.ButtonBase();
			this._buttonSeriesTotal = new Mtgdb.Controls.ButtonBase();
			this._buttonExplainTotal = new Mtgdb.Controls.ButtonBase();
			this._buttonFilterBySearchResult = new Mtgdb.Controls.ButtonBase();
		...
		private Mtgdb.Controls.ButtonBase _buttonArgumentTotal;
		private Mtgdb.Controls.ButtonBase _buttonSeriesTotal;
		private Mtgdb.Controls.ButtonBase _buttonExplainTotal;
		private Mtgdb.Controls.ButtonBase _buttonCollectionPrice;
		private Mtgdb.Controls.ButtonBase _buttonFilterBySearchResult;
