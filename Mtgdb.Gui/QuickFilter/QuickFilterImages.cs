...
namespace Mtgdb.Gui
{
	public static class QuickFilterImages
	{
		...
		private static readonly Bitmap[] _keywords =
		{
			...
			ResourcesAbilities.Ingest_processor,
