...
namespace Mtgdb.Data
{
	public class Field<TObj, TVal> : IField<TObj>
	{
		...
		public IOrderedEnumerable<TObj> OrderBy(IEnumerable<TObj> val, SortDirection order)
		{
		...
		public IOrderedEnumerable<TObj> ThenOrderBy(IOrderedEnumerable<TObj> val, SortDirection order)
		{
			if (order == SortDirection.Asc)
		...
		public List<KeyValuePair<List<object>, HashSet<TObj>>> GroupBy(IEnumerable<TObj> val, SortDirection order)
		{
		...
		public List<KeyValuePair<List<object>, HashSet<TObj>>> ThenGroupBy(List<KeyValuePair<List<object>, HashSet<TObj>>> val, SortDirection order)
		{
